...
SysCore::SysCore(std::string filePath) {
	...
	stageInfoIF = {
		...
		.die = false,
		.goAheadFuture = stageInfoIF.goAheadPromise.get_future(),
		.fwdedRs = 0,
		.fwdedRt = 0,
		.fwdedRd = 0,
		.fwdedAluResult = 0,
	...
	stageInfoID = {
		...
		.invalidateData = false,
		.die = false,
		.goAheadFuture = stageInfoID.goAheadPromise.get_future(),
		.fwdedRs = 0,
		.fwdedRt = 0,
		.fwdedRd = 0,
		.fwdedAluResult = 0,
	...
	stageInfoEX = {
		...
		.invalidateData = false,
		.die = false,
		.goAheadFuture = stageInfoEX.goAheadPromise.get_future(),
		.fwdedRs = 0,
		.fwdedRt = 0,
		.fwdedRd = 0,
		.fwdedAluResult = 0,
	...
	stageInfoMEM = {
		...
		.invalidateData = false,
		.die = false,
		.goAheadFuture = stageInfoMEM.goAheadPromise.get_future(),
		.fwdedRs = 0,
		.fwdedRt = 0,
		.fwdedRd = 0,
		.fwdedAluResult = 0,
	...
	stageInfoWB = {
		...
		.invalidateData = false,
		.die = false,
		.goAheadFuture = stageInfoWB.goAheadPromise.get_future(),
		.fwdedRs = 0,
		.fwdedRt = 0,
		.fwdedRd = 0,
		.fwdedAluResult = 0,
